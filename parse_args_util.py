...
def parse_args():
    ...
    parser.add_argument('--noise_min', type=float, default=0.001, help='noise lower bound for continous noise generating')
    parser.add_argument('--noise_max', type=float, default=0.01, help='noise upper bound for continous noise generating')
